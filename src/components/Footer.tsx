const Footer = () => {
  return (
    ...
    <footer
        className="flex flex-col items-center bg-zinc-50 text-center text-surface dark:bg-neutral-700 dark:text-white w-full absolute inset-x-0 bottom-0 h-full">
